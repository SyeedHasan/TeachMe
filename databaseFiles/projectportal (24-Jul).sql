...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 24, 2018 at 07:18 PM
...
CREATE TABLE `options` (
  ...
  `opt1` varchar(35) NOT NULL,
  `opt2` varchar(35) NOT NULL,
  `opt3` varchar(35) NOT NULL,
  `corrAns` varchar(35) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'Choudhry', 'Quaid', 'Ali', 'Choudhry'),
(2, 'Ahmed', 'Nawaz', 'Siddiq', 'Siddiq');
...
(1, 'Who invented the term \'Pakistan\'?', 1),
(2, 'Who is the founder of \'Pakistan\'?', 2),
(3, 'Who am I?', 1);
...
INSERT INTO `quiz` (`quizID`, `quizName`, `assignedBy`) VALUES
(1, 'Chemistry', 'Syed Hasan'),
(2, 'Physics', 'Sidra Saleem');
...
CREATE TABLE `quizresults` (
  ...
  `quizID` int(11) NOT NULL,
  `stMarks` int(11) DEFAULT NULL,
  `status` text COMMENT 'Holds whether the user has ''passed'' or failed'''
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(11, 'Syed', 'Ahsan', 'syed_ahsan', 'N@na.com', 'f690d3b8d4b51c1f189d886b7bab26b7', '2018-06-04', 'assets/images/profile_pics/defaults/default.png', 1, 1, 'no', ',syed_hasan,syed_ahsan,'),
(12, 'Syed', 'Hasan', 'hasanNaqi', 'Hasan@hasan.com', 'f690d3b8d4b51c1f189d886b7bab26b7', '2018-07-19', 'assets/images/profile_pics/defaults/default.png', 0, 0, 'no', ',');
...
--
ALTER TABLE `quizqs`
  ADD CONSTRAINT `quesID` FOREIGN KEY (`questionID`) REFERENCES `questions` (`questionID`),
